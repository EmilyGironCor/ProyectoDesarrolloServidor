...
public void mapearCredencialesLogin(Element eDatos) {
    // eDatos es el elemento raíz que contiene las etiquetas del cliente
    
    // 1. El cliente envió el nombre de usuario dentro de <usuario>
    if (eDatos.getChild("usuario") != null) {
        this.nombre = eDatos.getChild("usuario").getValue().trim();
    }
    
    // 2. El cliente envió la contraseña dentro de <password>
    if (eDatos.getChild("contrasena") != null) {
        this.contrasena = eDatos.getChild("contrasena").getValue().trim();
    }
    
    // Dejamos los demás campos por defecto en este momento
    this.id = 0;
    this.correo = "";
    this.estado = true;
    this.rol = 0;
...
//        eId.addContent(String.valueOf(this.id));
//
//        Element eNombre = new Element("nombre");
//        eNombre.addContent(this.nombre);
//
//        Element eCorreo = new Element("correo");
//        eCorreo.addContent(this.correo);
//
//        Element eContrasena = new Element("contrasena");
//        eContrasena.addContent(this.contrasena);
//
//        Element eEstado = new Element("estado");
//        eEstado.addContent(String.valueOf(this.estado));
//
//        eUsuario.addContent(eId);
//        eUsuario.addContent(eNombre);
//        eUsuario.addContent(eCorreo);
//        eUsuario.addContent(eContrasena);
//        eUsuario.addContent(eEstado);
//
//        return eUsuario;
//    }
    ...
    eUsuario.addContent(new Element("estado").setText(String.valueOf(this.estado)));
